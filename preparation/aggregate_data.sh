...
FILTER_VARIANT_PATH="kor_sfari_mssng.noncoding_DNV.20250226.tsv.gz"
OUTPUT_PATH="kor_sfari_mssng.enformer_sei_puffin.new_agg.v1.zarr"
OUTPUT_PATH2="kor_sfari_mssng.noncoding_raw.new_agg.v1.zarr"
SAMPLE_LIST_PATH="Korean_SFARI_MSSNG.14606samples.sample_list.20250224.txt"
NC_CPUS=10
